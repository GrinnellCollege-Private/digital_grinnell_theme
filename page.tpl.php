...
<div class="col-sm-8"><a href="/#" title="Click this Digital Grinnell logo to return to the Digital Grinnell home page." class="art-logo">
    <img id="dg-logo" class="img-responsive" src="<?php echo Digital_Grinnell_art_get_full_path_to_theme().'/'; ?>images/" . $banner . " alt="DG: Digital Grinnell: Sharing and preserving Grinnell's heritage" />
</a></div>
